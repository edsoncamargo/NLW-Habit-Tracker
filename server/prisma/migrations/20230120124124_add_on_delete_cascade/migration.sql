...
CREATE TABLE "new_habit_week_days" (
    ...
    CONSTRAINT "habit_week_days_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "habit" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "habit" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
